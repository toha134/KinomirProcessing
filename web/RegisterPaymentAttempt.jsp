	...
	try {
		...
		if (request.getParameter("o.mer_trx_id") != null) {
			...
			if ("1".equals(request.getParameter("result_code"))) {
				...
				final String attributes = new StringBuilder().append(request.getParameter("o.mer_trx_id")).append(" ").append(request.getParameter("p.cardholder")).append(" ").append(request.getParameter("ts")).toString();
