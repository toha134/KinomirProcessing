...
public class PurchaseMemento {
    ...
    public static void sendSuccessSms(Long idOrder, String smsUrl, String userId, String password, String login, String smsName) {
        Connection conn = null;
        Map<String, String> params = new HashMap<String, String>();
    ...
    public static void sendCancelSms(Long idOrder) {
        Connection conn = null;
        Map<String, String> params = new HashMap<String, String>();
        params.put(KinomirManager.IDORDER, idOrder.toString());
        try {
            ...
            ClientInfoDTO clientInfo = KinomirManager.getClientInfo(conn, params);
            String phone = clientInfo.getClientInfoField("Cellular");
            String smsText = String.format("\"Киномир: заказ №%1$d аннулирован из-за ошибки в платеже", new Object[]{idOrder});
            addSmsToQueue(phone, smsText, idOrder);
            logger.debug("after send sms");
        } catch (Exception ex) {
            logger.error("Error while send sms", ex);
